...
public class Integer extends PrimitiveDataType {
	public static final java.lang.String StartKeyword = "Integer";
	...
	public boolean equals(Object object) {
		...
		if (this.getValue() != ((compiler.data.Integer) value2).getValue()) return false;
		return true;
	}
