...
public class DoWhile extends Block {
	...
	public static final String EndKeyword = "While";

	Expression condition=null;

	
	public DoWhile(int startLineNumber, int endLineNumber) {
