...
public class Close extends FileCommand {
	public static final boolean Debug = Settings.Debug;
	
	public static final String StartKeyword = "Close";

	Literal variableName;

	
	public Close(int lineNumber) {
		super(lineNumber, StartKeyword);
	}

	public static boolean isAClose(String line) {
