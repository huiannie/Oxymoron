...
// Note: Print is literally exactly the same as Display.
// It is not clear why the author of the book suddenly switches 
...
public class Print extends FileCommand {
	public static final boolean Debug = Settings.Debug;
	
	public static final String StartKeyword = "Print";

	

	ArrayList<Expression> expressions;

	public Print(int lineNumber) {
		super(lineNumber, StartKeyword);
	}

	public static boolean isAPrint(String line) {
	...
	public void parse(ArrayList<String> code, Scope scope, Block parent) throws BugTrap {
		...
		// Syntax 1: Print
		// Syntax 2: Print expr [, expr] where expr can be anything
