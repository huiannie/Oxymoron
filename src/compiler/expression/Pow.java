...
public class Pow extends Operator {
	...
	public static final Pow op = new Pow();
	...
	public DataType evaluate(Literal leftValue, Literal rightValue) throws BugTrap {
		...
		if ((leftValue instanceof compiler.data.Integer) && (rightValue instanceof compiler.data.Integer)) {
			...
			return new compiler.data.Integer((int)Math.pow(value1,value2));
		}
			...
			return new compiler.data.Real((float) Math.pow(value1,value2));
		}
