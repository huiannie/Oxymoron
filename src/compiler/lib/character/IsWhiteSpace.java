...
public class IsWhiteSpace extends LibFunction {

	// Boolean isWhiteSpace(Character value)
	public static final String name = "isWhiteSpace";
	...
	public IsWhiteSpace() throws BugTrap {
	...
	public int execute(Context context) throws BugTrap {
		...
		if (value instanceof compiler.data.Character) {
			...
			setReturnValue( new compiler.data.Boolean( java.lang.Character.isWhitespace(x) ) , context);
		}
