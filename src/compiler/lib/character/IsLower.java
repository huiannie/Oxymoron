...
public class IsLower extends LibFunction {

	// Boolean isLower(Character value)
	public static final String name = "isLower";
	...
	public int execute(Context context) throws BugTrap {
		...
		if (value instanceof compiler.data.Character) {
			...
			setReturnValue( new compiler.data.Boolean( java.lang.Character.isLowerCase(x) ) , context);
		}
