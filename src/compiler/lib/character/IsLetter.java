...
public class IsLetter extends LibFunction {

	// Boolean isLetter(Character value)
	public static final String name = "isLetter";
	...
	public IsLetter() throws BugTrap {
	...
	public int execute(Context context) throws BugTrap {
		...
		if (value instanceof compiler.data.Character) {
			...
			setReturnValue( new compiler.data.Boolean( java.lang.Character.isLetter(x) ) , context);
		}
