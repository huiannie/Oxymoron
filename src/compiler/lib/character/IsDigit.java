...
public class IsDigit extends LibFunction {

	// Boolean isDigit(Character value)
	public static final String name = "isDigit";
	...
	public int execute(Context context) throws BugTrap {
		...
		if (value instanceof compiler.data.Character) {
			...
			setReturnValue( new compiler.data.Boolean( java.lang.Character.isDigit(x) ) , context);
		}
