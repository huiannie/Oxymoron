...
public class ToReal extends LibFunction {

	// Real toReal(Integer value)
	public static final String name = "toReal";
	...
	public int execute(Context context) throws BugTrap {
		...
		if (value instanceof compiler.data.Integer) {
			...
			setReturnValue( new compiler.data.Real(x) , context);
		}
		else {
