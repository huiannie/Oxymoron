...
public class RealToString extends LibFunction {

	// String realToString(Real value)
	public static final String name = "realToString";
	...
	public RealToString() throws BugTrap {
	...
	public int execute(Context context) throws BugTrap {
		...
		if (value instanceof compiler.data.Real) {
			float x = ((compiler.data.Real) value).getValue();
