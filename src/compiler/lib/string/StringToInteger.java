...
public class StringToInteger extends LibFunction {

	// Integer StringToInteger(String value)
	public static final String name = "stringToInteger";
	...
	public StringToInteger() throws BugTrap {
	...
	public int execute(Context context) throws BugTrap {
		...
		if (value instanceof compiler.data.String) {
			...
			int r = java.lang.Integer.parseInt(x);
